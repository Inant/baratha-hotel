            ...
            <form action="{{ route('user.update', $user->id) }}" method="post">
              ...
              <div class="card-body">
                  ...
                  @if (\Auth::user()->level == 'Owner')
                    ...
                    <div class="custom-control custom-radio custom-control-inline mr-5">
                      <input type="radio" value="Resepsionis" id="level4" name="level" class="custom-control-input" @error('level') is-invalid @enderror" {{old('level', $user->level) == 'Resepsionis' ? 'checked' : ''}}>
