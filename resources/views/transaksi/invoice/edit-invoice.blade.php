        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('transaksi.save-invoice') }}" method="post">
                    @csrf
                    <input type="hidden" id="kode" name='kode_transaksi' value="{{ $transaksi->kode_transaksi }}"
                        readonly>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="form-line-check">
                                    ...
                                    <input type="text"
                                        class="form-control form-line @error('nama_tamu') is-invalid @enderror"
                                        name='nama_tamu' value="{{ $transaksi->tamu->nama }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="form-line-check">
                                    <span class='fa fa-check-circle'></span>
                                    <input type="text"
                                        class="form-control form-line @error('jenis_identitas') is-invalid @enderror"
                                        name='jenis_identitas' value="{{ $transaksi->tamu->jenis_identitas }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="form-line-check">
                                    <span class='fa fa-check-circle'></span>
                                    <input type="text"
                                        class="form-control form-line @error('no_identitas') is-invalid @enderror"
                                        name='no_identitas' value="{{ $transaksi->tamu->no_identitas }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    <span class='fa fa-check-circle'></span>
                                    <input type="text"
                                        class="form-control form-line @error('tgl_checkin') is-invalid @enderror"
                                        name='tgl_checkin' value="{{ $transaksi->tgl_checkin }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    <span class='fa fa-check-circle'></span>
                                    <input type="text"
                                        class="form-control form-line @error('tgl_checkout') is-invalid @enderror"
                                        name='tgl_checkout' value="{{ $transaksi->tgl_checkout }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    ...
                                    <input type="text"
                                        class="form-control form-line @error('tgl_checkout') is-invalid @enderror"
                                        name='tgl_checkout' value="{{ $transaksi->tipe_pemesanan }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    ...
                                    <input type="text" class="form-control form-line" name=''
                                        value="{{ $durasi }}" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                <input type="number" name="total_extra_bed" id="total_extra_bed"
                                    class="total_extra_bed form-control" value="{{ old('total_extra_bed', 0) }}">
                            </div>
                        </div>
                        <div class="row">
                            <?php
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="number" name="total" id="total" class="getGrandTotal form-control"
                                    value="{{ $total }}"
                                    {{ $transaksi->tipe_pemesanan == 'Website' ? 'readonly' : '' }}>
                            </div>
                            <div class="col-4 mb-2">
                                <label for=""><strong>Diskon</strong></label>
                                <input type="number" id="diskon_tambahan" name="diskon"
                                    class="form-control getGrandTotal <?php echo $transaksi->status_bayar == 'DP50%' ? 'dp' : ''; ?>"
                                    value="{{ old('diskon', $diskon) }}" data-tipe='rp'
                                    data-tipe_pemesanan="{{ $transaksi->tipe_pemesanan == 'Offline' || $transaksi->tipe_pemesanan == 'Website' ? 'langsung' : 'travel_agent' }}">
                            </div>
                            <?php
                      if($transaksi->status_bayar!='DP50%'){
                    ?>
                            <div class="col-4 mb-2">
                                ...
                                <input type="number" name="tax" class="form-control getGrandTotal"
                                    value="{{ old('tax', $tax) }}" data-tipe='rp'
                                    {{ $transaksi->tipe_pemesanan == 'Website' ? 'readonly' : '' }} id="tax">
                            </div>
                            <?php } ?>
                            <div class="col-4 mb-2">
                                <label for=""><strong>Metode Pembayaran</strong></label>
                                <select name="jenis_pembayaran"
                                    class="form-control select2 @error('bayar') is-invalid @enderror" id="jenis_bayar">
                                    <option value="Tunai"
                                        {{ old('jenis_pembayaran', $jenis_pembayaran) == 'Tunai' ? 'selected' : '' }}>Tunai
                                    </option>
                                    <option value="Debit BCA"
                                        {{ old('jenis_pembayaran', $jenis_pembayaran) == 'Debit BCA' ? 'selected' : '' }}>
                                        Debit BCA</option>
                                    <option value="Debit BRI"
                                        {{ old('jenis_pembayaran', $jenis_pembayaran) == 'Debit BRI' ? 'selected' : '' }}>
                                        Debit BRI</option>
                                    <option value="Debit Bank Lain"
                                        {{ old('jenis_pembayaran', $jenis_pembayaran) == 'Debit Bank Lain' ? 'selected' : '' }}>
                                        Debit Bank Lain</option>
                                    <option value="Kredit BCA"
                                        {{ old('jenis_pembayaran', $jenis_pembayaran) == 'Kredit BCA' ? 'selected' : '' }}>
                                        Kredit BCA</option>
                                    <option value="Kredit BRI"
                                        {{ old('jenis_pembayaran', $jenis_pembayaran) == 'Kredit BRI' ? 'selected' : '' }}>
                                        Kredit BRI</option>
                            ...
                            <div class="col-4 mb-2">
                                <div id="">
                                    ...
                                    <input type="number" name="charge" id="charge"
                                        class="getGrandTotal form-control" value="{{ old('charge', $charge) }}">
                                    {{-- @error('jenis_pembayaran')
                          <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                          </span>
                        ...
                        <h5 class="text-default">*Khusus Customer Travel</h5>
                            ...
                            <div class="col-md-4 mt-4">
                                <h1 class='text-dark'>Grand Total : Rp. <span class="text-orange"
                                        id='idrGrandTotal'>{{ number_format($bayar, 0, ',', '.') }}</span></h1>
