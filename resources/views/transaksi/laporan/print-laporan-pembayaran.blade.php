...
<table width="100%" cellspacing="0" cellpadding="5">
  ...
  <?php
      ...
      $total_ppn = $total_ppn + $value->tax;
      $subtotal = $value->total - $value->diskon;
...
@if (isset($_GET['xls']))
    @php
        $name = 'Laporan Pembayaran ' . date('d-m-Y', strtotime($_GET['dari'])).' s/d '.date('d-m-Y', strtotime($_GET['sampai'])).'.xls';
