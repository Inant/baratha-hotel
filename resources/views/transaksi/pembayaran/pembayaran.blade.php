...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action="{{ route('transaksi.save-pembayaran')}}" method="post">
              @csrf
              ...
              <h6 class="heading-small text-muted mb-4">Informasi Umum</h6>
                  ...
                  <div class="row">
                    ...
                    <div class="col-4 mb-2">
                      ...
                      <select name="jenis_pembayaran" class="form-control select2 @error('bayar') is-invalid @enderror" id="jenis_pembayaran">
