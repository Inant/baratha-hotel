            ...
            <form action="{{ route('tamu.update', $tamu->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <label for="" class="form-control-label">Nama Tamu</label>
                    <input type="text" name="nama" value="{{old('nama', $tamu->nama)}}" class="form-control @error('nama') is-invalid @enderror">
                    @error('nama')
                    ...
                    <div class="custom-control custom-radio custom-control-inline  ml-2 mr-5">
                        <input type="radio" value="KTP" id="customRadioInline1" name="jenis_identitas" class="custom-control-input" @error('jenis_identitas') is-invalid @enderror" {{old('jenis_identitas', $tamu->jenis_identitas) == 'KTP' ? 'checked' : ''}}>
                        <label class="custom-control-label" for="customRadioInline1">KTP</label>
                    </div>
                    
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" value="SIM" id="customRadioInline2" name="jenis_identitas" class="custom-control-input" @error('jenis_identitas') is-invalid @enderror" {{old('jenis_identitas', $tamu->jenis_identitas) == 'SIM' ? 'checked' : ''}}>
                    ...
                    <input type="text" name="no_identitas" value="{{old('no_identitas', $tamu->no_identitas)}}" class="form-control @error('no_identitas') is-invalid @enderror">
                    @error('no_identitas')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input type="text" name="street" value="{{old('street', $tamu->street)}}" class="form-control @error('street') is-invalid @enderror">
                    @error('street')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input type="text" name="city" value="{{old('city', $tamu->city)}}" class="form-control @error('city') is-invalid @enderror">
                    @error('city')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input type="text" name="phone" value="{{old('phone', $tamu->phone)}}" class="form-control @error('phone') is-invalid @enderror">
                    @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
